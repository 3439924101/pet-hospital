...
<head>
    <meta charset="UTF-8">
    <title>注册界面</title>
    <link rel="stylesheet" type="text/css" href="/_war_exploded/用户注册/用户注册.css">
</head>
<body>
<div id="log" >
    <div id="log1"><h3 id="h3">用户注册</h3>
        <form name="form1" method="post" action="/_war_exploded/RegisterServlet">
            <table>
                <tr>
                    <td>用户：</td>
